...
<head>
    ...
    <meta name="author" content="Trippy">
...
<body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <nav class="navbar navbar-expand-lg navbar-dark">
                            <a class="navbar-brand" href="index.html">Trippy</a>
                ...
                <span class="icon-menu"></span>
                    ...
                    <span class="icon-arrow-down"></span>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                            ...
                                            <a class="dropdown-item" href="#">Pondicherry</a>
                    ...
                    <span class="icon-arrow-down"></span>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                            <a class="dropdown-item" href="reply.php">Reply</a>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-md-12">
                    <div class="slider-title_box">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slider-content_wrap">
                                    <h1>Discover great places in India</h1>
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-10">
                                <form method="post" action="searchprocess.php" class="form-wrap mt-4">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                       <select name="category" class="btn-group2" required>
        									...
        									<option><?php echo $res['name'];
												$from = $res['name'];?></option>
											<?php } ?>
										</select>
										
										<select name="city" class="btn-group2" required>
											<option class="dropdown-item" value="#">---Choose a city---</option>
											<?php
												$query= "SELECT DISTINCT(Name) FROM `cities` ORDER BY Name";
												$a=mysqli_query($conn,$query);
												while($res=mysqli_fetch_array($a))
											{?>
        									<option><?php echo $res['Name'];
                                        ...
                                        <button type="submit" name="search" class="btn-form"><span class="icon-magnifier search-icon"></span>SEARCH<i class="pe-7s-angle-right"></i></button>
                                    </div>
                                </form>
                                <div class="slider-link">
                                    <a href="listing.php">Browse Popular</a><span>or</span> <a href="listing.php">Recently Added</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row find-img-align">
                        <div class="col-md-12">
                            <div class="find-place-img_wrap">
                                <div class="grid">
                                    <figure class="effect-ruby">
                                        <a href="hotels.php"><img src="images/find-place4.jpg" class="img-fluid" alt="img13" /></a>
                                        <figcaption>
                                            <h5>Hotels </h5>
                                            <p>06 Options</p>
                                        </figcaption>
	...
	?>
				...
				<?php
		include("includes/conn.php");
		$query='select * from restaurant where name = "Pizza-Cicis"';
		$result = $conn->query($query);
		    while($row = $result->fetch_assoc()){
	?>
                <div class="col-md-4 featured-responsive">
                    <div class="featured-place-wrap">
                        <a href="detail.php">
                            ...
                            <span class="featured-rating-green"><?php echo $row['review']?></span>
                            <div class="featured-title-box">
                                <h6><?php echo $row['name']?></h6>
                                <p><?php echo $row['category']?></p> <span>• </span>
                                <p>3 Reviews</p> <span> • </span>
				...
				<?php
		include("includes/conn.php");
		$query='select * from restaurant where name = "Khaana Khazana"';
		$result = $conn->query($query);
		    while($row = $result->fetch_assoc()){
	?>
                <div class="col-md-4 featured-responsive">
                    <div class="featured-place-wrap">
                        <a href="detail.php">
                            ...
                            <span class="featured-rating"><?php echo $row['review']?></span>
                            <div class="featured-title-box">
                                <h6><?php echo $row['name']?></h6>
                                <p><?php echo $row['category']?> </p> <span>• </span>
                                <p>2 Reviews</p> <span> • </span>
                                <p><span><?php echo $row['cost']?></span>/5(in RS)</p>
                                <ul>
                                    <li><span class="icon-location-pin"></span>
                                        <p><?php echo $row['address']?></p>
                                ...
                                <div class="bottom-icons">
                                    <div class="open-now"><?php echo $row['status']?></div>
                                    <span class="ti-heart"></span>
                                    <span class="ti-bookmark"></span>
                                </div>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row">
              ...
              <g>
                ...
                <div class="col-md-3 category-responsive">
                    <a href="hotels.php" class="category-wrap">
                        <div class="category-block">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="add-listing-wrap">
                        ...
                        <p>Add your Business infront of millions</p>
                    </div>
                </div>
            </div>
<!--
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="featured-btn-wrap">
                        <a href="#" class="btn btn-danger"><span class="ti-plus"></span> ADD A PLACE</a>
                    </div>
                </div>
            </div>
-->
    ...
    <footer class="main-block dark-bg">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="copyright">
                        <p>Copyright &copy; 2019 Trippy. All rights reserved | This is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="ourteam.html">Team Trippy</a></p>
                        <ul>
